...
class ARCroco3DStereo(CroCoNet):
    ...
    def __init__(self, config: ARCroco3DStereoConfig):
        ...
        config.croco_kwargs = fill_default_args(config.croco_kwargs, CroCoNet.__init__)
        self.config = config
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kw):
        ...
        raise FileNotFoundError(
            f"Local checkpoint not found: {pretrained_model_name_or_path}"
        )
