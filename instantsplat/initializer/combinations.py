...
def DepthAnythingV2VGGTColmapDenseInitializer(
        input_size=518,
        encoder='vitl',
        checkpoints_folder='checkpoints',
        device="cuda",
        *args, **kwargs):
    return AutoScaleDepthAnythingV2InitializerWrapper(
        VGGTColmapDenseInitializer(*args, **kwargs),
        input_size=input_size,
        encoder=encoder,
        checkpoints_folder=checkpoints_folder,
        device=device,
...
def DepthAnythingV2VGGTColmapSparseInitializer(
        input_size=518,
        encoder='vitl',
        checkpoints_folder='checkpoints',
        device="cuda",
        *args, **kwargs):
    return AutoScaleDepthAnythingV2InitializerWrapper(
        VGGTColmapSparseInitializer(*args, **kwargs),
        input_size=input_size,
        encoder=encoder,
        checkpoints_folder=checkpoints_folder,
        device=device,
...
def DepthAnythingV2VGGTInitializer(
        input_size=518,
        encoder='vitl',
        checkpoints_folder='checkpoints',
        device="cuda",
